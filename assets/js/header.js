        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) {
                document.addEventListener("click", (function(e) {
                    ...
                    if (bodyLockStatus && !e.target.closest(".menu__list") && document.documentElement.classList.contains("menu-open")) {
                        bodyUnlock();
            ...
            if (document.querySelector(".icon-search")) {
                document.addEventListener("click", (function(e) {
                    ...
                    if (bodyLockStatus && !e.target.closest(".search") && document.documentElement.classList.contains("search-open")) {
                        bodyUnlock();
                        document.documentElement.classList.remove("search-open");
                    }
                }));
                document.addEventListener("keydown", (function(e) {
                    if (bodyLockStatus && e.code === "Escape" && document.documentElement.classList.contains("search-open")) {
                        bodyUnlock();
                        document.documentElement.classList.remove("search-open");
                    }
                }));
